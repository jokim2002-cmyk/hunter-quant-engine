...
Scope:
- Read backtest metrics engine output.
...
Scope:
- Read strategy mode backtest run matrix pack.
...
- Audit deterministic option reference pricing assumptions.
- Write JSON, text, CSV, and manifest evidence outputs.
- Keep backtest execution, optimization, strategy changes, broker/live execution, live data, real orders, real money, and profitability claims out of scope.
...
Scope:
- Read the paper tuning candidate readiness pack.
- Read the paper slippage and cost sensitivity pack.
- Audit current paper exit-rule assumptions for stop loss, take profit, timeout,
  session close, intrabar path, and exit distribution sensitivity.
- Write JSON, text, CSV, and manifest evidence outputs.
- Keep backtest execution, optimization, strategy logic changes, broker/live
  execution, live market data, real orders, real money, and profitability claims
  out of scope.
...
Scope:
- Read the improved recorded-data paper rerun planning pack.
- Check local recorded dataset presence and row count.
- Verify paper-only preflight gates before any future improved rerun runner.
- Write JSON, text, CSV, and manifest evidence outputs.
- Keep backtest execution, optimization, strategy logic changes, broker/live execution, live market data, real orders, real money, and profitability claims out of scope.
...
- Phase 7 Improved Recorded-Data Paper Rerun Sprint pending after Module CCCCC: 2 modules.
- Full HQE product estimate after Module CCCCC: 96-99%.

Expected full quick-check suite after Module CCCCC: verify with `.\.venv\Scripts\python.exe -m pytest`.
...
Scope:
- Read the improved recorded-data paper rerun preflight pack.
- Lock future runner controls and output contract.
- Define recorded-data-only, broker-disabled, no-real-orders, paper-option-buy, skipped-reason, and no-profit-claim gates.
- Write JSON, text, CSV, and manifest evidence outputs.
- Keep backtest execution, optimization, strategy logic changes, broker/live execution, live market data, real orders, real money, and profitability claims out of scope.
...
- Phase 7 Improved Recorded-Data Paper Rerun Sprint pending after Module DDDDD: 1 module.
...
Scope:
- Read the Phase 7 close pack.
- Build the future runner scaffold contract.
- Lock local-file input loading, recorded-data-only mode, paper option-buy trade mapping, improvement layer pipeline, skipped-reason output contract, broker/live/real-order disablement, and no-profit-claim reporting.
...
- Phase 8 Safe Improved Recorded-Data Paper Rerun Runner Build started.
- Completed total before Module FFFFF: 109 modules.
- Completed total after Module FFFFF: 110 modules.
- Phase 8 Safe Improved Recorded-Data Paper Rerun Runner Build pending after Module FFFFF: 2 modules.
...
Scope:
- Read the Phase 8 runner scaffold evidence.
- Read the Phase 8 dry-run validation evidence.
- Close Phase 8 when inputs are found, pass, accepted, and safe.
- Gate the next phase for a guarded paper-only runner execution module.
- Write JSON, text, CSV, and manifest evidence outputs.
- Keep backtest execution, optimization, strategy logic changes, broker/live execution, live market data, real orders, real money, and profitability claims out of scope.
...
- Phase 8 Safe Improved Recorded-Data Paper Rerun Runner Build pending after Module HHHHH: 0 modules.
...
Scope:
- Read the Module JJJJJ execution plan when available.
- Create the future guarded paper runner contract.
- Lock the recorded-dataset boundary.
- Lock the paper-only execution boundary.
- Lock LONG = CE BUY paper plan, SHORT = PE BUY paper plan, and NEUTRAL = no trade.
- Lock no-live, no-broker, no-real-order, no-real-money, and no-profitability-claim rules.
- Keep runner execution disabled in this module.
- Write JSON, text, CSV, and manifest evidence outputs.
...
- Phase 9 Safe Improved Recorded-Data Paper Runner Execution pending after Module KKKKK: 1 module.
...
Scope:
- Read the Module LLLLL Phase 9 close pack when available.
- Start Phase 10 safe paper-runner review readiness.
- Keep runner execution disabled in this module.
- Confirm broker, live data, real orders, real money, and profitability claims remain disabled.
- Write JSON, text, CSV, and manifest evidence outputs.
...
- Phase 10 Safe Paper Runner Review pending after Module MMMMM: 2 modules.
- Full HQE product estimate after Module MMMMM: 99%.

Expected full quick-check suite after Module MMMMM: verify with `.\\.venv\\Scripts\\python.exe -m pytest`.
...
Scope:
- Read the Module MMMMM review-readiness pack when available.
- Define review criteria for future paper-runner evidence.
- Keep runner execution disabled in this module.
- Confirm broker, live data, real orders, real money, and profitability claims remain disabled.
- Write JSON, text, CSV, and manifest evidence outputs.
...
- Phase 10 Safe Paper Runner Review pending after Module NNNNN: 1 module.
...
Scope:
- Read the Module PPPPP execution review readiness pack when available.
- Define safe paper-runner execution review criteria.
- Keep runner execution disabled in this module.
- Confirm broker, live data, real orders, real money, and profitability claims remain disabled.
- Write JSON, text, CSV, and manifest evidence outputs.
...
- Phase 11 Safe Paper Runner Execution Review pending after Module QQQQQ: 1 module.
- Full HQE product estimate after Module QQQQQ: 99%.

Expected full quick-check suite after Module QQQQQ: verify with `.\\.venv\\Scripts\\python.exe -m pytest`.
...
Scope:
- Read the Module QQQQQ execution-review criteria pack when available.
- Close Phase 11 with explicit safe paper/simulation evidence.
- Keep runner execution disabled in this module.
- Confirm broker, live data, real orders, real money, and profitability claims remain disabled.
- Write JSON, text, CSV, and manifest evidence outputs.
...
- Phase 11 Safe Paper Runner Execution Review pending after Module RRRRR: 0 modules.
