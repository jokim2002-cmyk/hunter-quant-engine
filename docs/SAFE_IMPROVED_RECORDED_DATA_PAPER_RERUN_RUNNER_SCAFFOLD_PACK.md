...
Purpose:
This pack builds the safe runner scaffold contract for a future improved
recorded-data paper rerun. It does not execute a backtest.

Default input:
- `reports\paper_trading\improved_recorded_data_paper_rerun_sprint_close_pack\improved_recorded_data_paper_rerun_sprint_close_pack.json`
...
- `safe_improved_recorded_data_paper_rerun_runner_scaffold_pack.txt`
- `safe_improved_recorded_data_paper_rerun_runner_scaffold_components.csv`
- `manifest.json`
